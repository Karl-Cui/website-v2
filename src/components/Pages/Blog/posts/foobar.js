...
One of the questions set me on an adventure.
...
It turns out that __the Foobar challenge allows importing NumPy now__ (and possibly some other libraries, I haven't tried).
